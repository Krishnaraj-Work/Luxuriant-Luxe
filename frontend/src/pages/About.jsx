	...
	return (
		<div id="about_div">
			<section
				...
				id="intro"
			>
				<div className="text-5xl bulgatti my-6 mb-3">About Us</div>
				...
				<div className="text-xl mt-4 prata text-left  text-center">
					luxuriant luxe wont give you the false expectations from the
					product your natural skin will be enhanced and become more
					like what you want.
				</div>
			</section>

			<section
				className="flex flex-col p-2 m-8 justify-center items-center "
				id="intro"
			>
				<div className="text-5xl bulgatti my-6">Only Premium</div>
			...
			<section
				...
				id="intro"
			>
				<div className="text-5xl bulgatti my-6 text-center">
					Why are we special?
				</div>
			...
			>
				...
				<div className="flex flex-col gap-4">
					...
					<div className="text-xl mt-4 prata text-left p-4 m-5 text-center">
						<span className="text-accent prata text-xl">
							Two people who got influenced by the ancient
							skincare heritage from the 1st century and made it
							time travel to 2023 for you.
						</span>
					</div>
				</div>
			</section>
